...
export default function Header() {
    ...
    return (
        <div className='flex justify-between items-center text-xs sm:text-base gap-1 sm:-ml-0 bg-opacity-40'>
            {/* // logo part */}
            <header>
                <Link to={'/'} className='flex items-center gap-1 mt-2 sm:mt-0'>
                    ...
                    <span className='font-bold text-xl mb-1'>Roomify</span>
                </Link>
            </header>

            {/* center part - search vgera */}
            <div className='flex border border-gray-300 rounded-full py-2 px-4 gap-2 shadow-md shadow-grey-300 items-center'>
                <div>Anywhere</div>
            ...
            <Link to={user ? '/account' : '/login'} className="flex border border-gray-300 rounded-full py-2 px-4 gap-2 shadow-md shadow-grey-300 items-center">
